...
(function() {
  ...
  function showInstallPrompt() {
    ...
    banner.innerHTML = '<div style="display:flex;align-items:center;gap:10px;"><span style="font-size:22px;">📱</span><div><strong style="color:#ffd28a;display:block;font-size:13px;">添加备婚智囊快捷方式</strong><span style="color:#b9aed1;font-size:11px;">添加到手机桌面，即开即用快捷访问</span></div></div><div style="display:flex;gap:6px;"><button id="btnPwaInstall" style="background:linear-gradient(90deg,#ffd28a,#ff6b9d);border:0;border-radius:999px;padding:6px 12px;font-size:12px;font-weight:bold;color:#1a0f1f;cursor:pointer;">添加</button><button id="btnPwaClose" style="background:none;border:0;color:#aaa;font-size:16px;cursor:pointer;padding:0 4px;">✕</button></div>';
